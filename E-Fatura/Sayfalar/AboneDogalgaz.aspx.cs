...
{
    public partial class AboneDogalgaz : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Boolean sorgula = yonet.dogalgazFaturaSorgula(aboneNo.Text);
            if (sorgula == true)    //True dönerse abone vardır.Eğer abone varsa 
            {
                Session["AboneNo"] = aboneNo.Text ; //Abone girişi için Session'ı doldur.
                // Abone Doğalgaz sorguladıysa Session değer oluşturur.
                //Diğer sayfalarda giriş yaptığımızı bilmek için session kullandık.
                Session["AboneNu"] = null;  //Bu session Su faturası için gereklidir. Bu nedenle içi boştur.
                Response.Redirect("AboneDogalgaz.aspx"); //Sayfayı yenilemek için. 
            }
            else    //Eğer abone yoksa Gridview'i boşalt ve uyarı ver.
            {
                GridViewDogalgaz.Columns.Clear();
        ...
        protected void GridViewDogalgaz_SelectedIndexChanged(object sender, EventArgs e)
        {
